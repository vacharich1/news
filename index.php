	...
	foreach ($events['events'] as $event) {
		...
		{*/
			if($event['source']['groupId'] == 'C3a2c6e07a8f61c1153ec21a1043a1ee2' || $event['source']['groupId'] == 'C8542b6b5b88a7e15f5bc766e8311dd81' ||
			   ...
			   || $event['source']['groupId'] == 'Ca363ed4dc111731fef7ca985fa511eef')
			{
